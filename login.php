                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="auth_process.php" method="POST">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="cambiar_contra.php" style="color: #5e0606; font-size: 0.9rem;">¿Olvidaste tu
                                    contraseña?</a>
                            </div>
                            ...
                            <div class="text-center mt-3">
                                <p class="mb-0">¿No tienes una cuenta? <a href="register.php"
                                        style="color: #5e0606;">Regístrate aquí</a></p>
                            </div>
                        </form>
                    </div>
                </div>
