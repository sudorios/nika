...
@media (max-width: 768px) {
  ...
  .campo-formulario textarea {
    font-size: 16px; /* Mejor para móviles */
        ...
        <title>ING. Munayco Peralta Jorge David</title>
    </head>
    <body>
        <header>
            <p> 960721957// jdmp@gmail.com </p>
        ...
        <section>
            ...
            <div class="estudios-contenedor">
                <div class="estudio-box">
                    <img src="assets/images/cv/san_martin.jpg" alt=""/>
                    <h3>I.E San Martin</h3>
                    <p>Primaria</p>
                    <p>2010- 2015</p>
                </div>
                <div class="estudio-box">
                    <img src="assets/images/cv/portillo.jpg" alt=""/>
                    <h3>I.E  Coronel Pedro Portillo Silva</h3>
                    <p>Secundaria</p>
                    <p>2016 - 2020</p>
                </div>
                <div class="estudio-box">
